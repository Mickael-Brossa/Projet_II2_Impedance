...
Le banc d'essai est réalisé selon le schéma de la photo Montage.jpg. Le dispositif en lui-même est capable de mesuré des résistance et des capacité à une incertidude proche de 10 %, et cela en faisant varier une résistance, dite de calibrage, et la fréquence du signal sinusoïdale s'abattant sur l'impédance à mesurer. Cette variation de résistance et de fréquence est réalisé par la carte automatiquement, à une vitesse de 2 seconde de variation de la résistance ou de la fréquence. La fréquence du signal sinusoïdale est modifié intrinséquement par la carte, et la résistance de calibrage est modifié par un multiplexeur, controlée par deux pins de la carte.
